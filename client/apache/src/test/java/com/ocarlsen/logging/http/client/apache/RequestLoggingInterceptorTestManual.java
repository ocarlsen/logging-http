...
// TODO: Finish
public class RequestLoggingInterceptorTestManual {
    ...
    public void process() throws Exception {
        ...
        try (final CloseableHttpClient httpclient = HttpClients.custom().addInterceptorFirst(requestInterceptor).build()) {
