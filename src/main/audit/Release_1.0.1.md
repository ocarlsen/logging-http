...
* [ ] Confirm changes on GitHub [main](https://github.com/ocarlsen/logging-http/tree/main)
        
* [ ] Confirm build running on GitHub [Actions](https://github.com/ocarlsen/logging-http/actions)

* [ ] Check [SonarCloud](https://sonarcloud.io/dashboard?id=ocarlsen_logging-http) for quality metrics

* [ ] Go go GitHub [Tags](https://github.com/ocarlsen/logging-http/tags) and make release from new tag
...
* [ ] Confirm on [Releases](https://github.com/ocarlsen/logging-http/releases) page
...
* [ ] Confirm site w/ latest version at [GitHub Pages](https://ocarlsen.github.io/logging-http/)
